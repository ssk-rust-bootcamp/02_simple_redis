...
fn criterion_benchmark(c: &mut criterion::Criterion) {
    ...
    c.bench_function("v1_decode", |b| b.iter(|| v1_decode(black_box(&mut buf.clone()))));
    c.bench_function("v2_decode", |b| b.iter(|| v2_decode(black_box(&mut buf.clone()))));
